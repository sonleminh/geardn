...
const productSeedList = [
  ...
  {
    name: 'Bàn phím cơ không dây AULA S75',
    slug: 'ban-phim-co-khong-day-aula-S75',
    description: '<p>Bàn phím cơ không dây AULA S75</p>',
    brand: 'Aula',
    images: [
  ...
  },
  {
    ...
    description: '<p>Chuột có dây Logitech B100</p>',
    brand: 'Logitech',
    images: [
